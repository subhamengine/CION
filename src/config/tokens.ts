...
import { ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, MAINNET, TESTNET, MUMBAI } from "./chains";
...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [MUMBAI]: [
    ...
    },
    {
      ...
      symbol: "WCANTO",
      decimals: 18,
      address: "0x67D6973ee33707549CB76F10747751977d08dEC0",
      isWrapped: true,
      baseSymbol: "CANTO",
      imageUrl: "https://assets.coingecko.com/coins/images/12559/small/coin-round-red.png?1604021818",
    },
    {
      name: "Ethereum",
      symbol: "ETH",
      address: "0x16dF0ef3f93e3Be25ceb3801950d640DA7F01f4c",
      decimals: 18,
      isShortable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/279/small/ethereum.png?1595348880",
    },
    ...
    // },
    {
      name: "USD Coin",
      symbol: "USDC",
      address: "0x1Ae2CF82E99aB92aADCDAC2dA867B5E701A4d8ae",
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
    {
      name: "USD Tether",
      symbol: "USDT",
      address: "0x3F2aDcFA9583f52Fe0967db86eB605aEe057CDbb",
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
    {
      name: "ATOM",
      symbol: "ATOM",
      address: "0x9a97C2121103A0BbC3f79e671Ba0Fce547E9D3aC",
      decimals: 18,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
  ...
  [MUMBAI]: [
    {
      name: "CION",
      symbol: "CION",
      address: getContract(MUMBAI, "GMX"),
      decimals: 18,
      imageUrl: "https://assets.coingecko.com/coins/images/18323/small/arbit.png?1631532468",
    },
    {
      name: "Escrowed CION",
      symbol: "esCION",
      address: getContract(MUMBAI, "ES_GMX"),
      decimals: 18,
    },
    {
      name: "CION LP",
      symbol: "CLP",
      address: getContract(MUMBAI, "GLP"),
      decimals: 18,
      imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  ],
...
export const PLATFORM_TOKENS: { [chainId: number]: { [symbol: string]: Token } } = {
  ...
  [MUMBAI]: {
    ...
    GLP: {
      ...
      symbol: "CLP",
      decimals: 18,
      address: getContract(MUMBAI, "StakedGlpTracker"), // address of fsGLP token because user only holds fsGLP
      imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  },
};
...
// const CHAIN_IDS = [MAINNET, TESTNET, ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, MUMBAI];
const CHAIN_IDS = [MUMBAI];
